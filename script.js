...
quoteForm.addEventListener('submit', async function(e) {
    ...
    try {
        // Here you would integrate with Coda API
...
// Simulate form submission (replace with actual Coda integration)
async function simulateFormSubmission(data) {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            // Simulate success (90% success rate)
            if (Math.random() > 0.1) {
                console.log('Form data that would be sent to Coda:', data);
                resolve(data);
            } else {
